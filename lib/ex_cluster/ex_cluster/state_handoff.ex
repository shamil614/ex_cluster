defmodule ExCluster.StateHandoff do
  ...
  def join(neighbour_node) do
    ...
    GenServer.call(__MODULE__, {:set_neighbours, {__MODULE__, neighbour_node}}, 10_000)
  end
  ...
  def handle_call({:set_neighbours, {_module, _neighbour_node} = module_node}, _from, crdt_pid) do
